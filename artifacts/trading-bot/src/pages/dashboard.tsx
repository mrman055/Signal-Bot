            ...
            <div className={`p-8 md:p-12 ${recommendation.direction === 'BUY' ? 'bg-[hsl(var(--buy))/0.05]' : 'bg-[hsl(var(--sell))/0.05]'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-red-950/20 border border-red-500/20 p-4">
                  <div className="text-sm font-bold uppercase tracking-widest text-red-400 mb-1 flex items-center gap-2">
                    <ShieldAlert className="w-4 h-4" /> Stop Loss
                  </div>
                  <div className="font-mono text-xl text-red-400">{recommendation.stopLoss ?? "-"}</div>
                </div>
                <div className="bg-green-950/20 border border-green-500/20 p-4">
                  <div className="text-sm font-bold uppercase tracking-widest text-green-400 mb-1 flex items-center gap-2">
